...
Currently supported distributions are listed below:
 ...
 NOTE: There is an issue with the IAM policies in the cloudformation template. Create this custom policy and apply it to the AMI builder role before running the cloud build job:

 https://www.packer.io/docs/builders/amazon#iam-task-or-instance-role
 {
  "Version": "2012-10-17",
  "Statement": [
    {
